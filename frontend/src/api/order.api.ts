...
export const orderApi = {
  ...
  addToCart: (data: { menuItemId: string; quantity: number; variantId?: string; addonIds?: string[] }) => api.post("/api/orders/cart/items", data),
  ...
  confirmOrder: (bookingId: string) => api.post("/api/orders/confirm", { bookingId }),
