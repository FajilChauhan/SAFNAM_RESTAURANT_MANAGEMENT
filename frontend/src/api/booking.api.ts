...
export const bookingApi = {
  getAvailability: (params: { date: string; floorId?: string }) => api.get("/api/bookings/available-tables", { params }),
  getAvailableRooms: (params: { date: string; floorId?: string }) => api.get("/api/bookings/available-rooms", { params }),
  createBooking: (data: { tableId?: string; roomId?: string; date: string; timeSlot: string; guests: number; notes?: string }) =>
