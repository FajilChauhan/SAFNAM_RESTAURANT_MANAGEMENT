...
const emptyForm: Form = { categoryId: "", name: "", description: "", price: "", preparationTimeMin: "15", imageUrl: "", foodType: "VEG", spicyLevel: "NONE", status: "ACTIVE", isTodaySpecial: false, isAvailable: true };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
        <div className="flex justify-end"><Button onClick={openCreate} disabled={!categories.length} leftIcon={<Plus size={16} />}>Add Menu Item</Button></div>
